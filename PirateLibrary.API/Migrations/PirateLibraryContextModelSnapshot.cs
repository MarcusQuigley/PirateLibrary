...
using PirateLibrary.API;

namespace PirateLibrary.API.Migrations
{
    [DbContext(typeof(PirateLibraryContext))]
    partial class PirateLibraryContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PirateLibrary.API.Entities.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("PirateLibrary.API.Entities.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("PirateLibrary.API.Entities.Book", b =>
                {
                    b.HasOne("PirateLibrary.API.Entities.Author", "Author")
                        .WithMany("Books")
